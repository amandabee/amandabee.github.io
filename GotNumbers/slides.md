    ...
    © 2013 Ben Lesser and Amanda Hickman
...
<section>
    ...
    **The Less Basics**
    ...
    <aside class="notes">
    This is our roadmap. You covered a lot of this in fundamentals so it should go fast. </aside>
</section>
<section>
    # Rounding
...
<section>
    ...
    Starting Point: 39370



    <aside class="notes">We 
    </aside>
</section>
<section>
    # Percent Change
...
<section>
    ...
    Nina Golgowski  NEW YORK DAILY NEWS, Nov 12, 2013
    http://www.nydailynews.com/news/world/philippine-president-typhoon-haiyan-death-toll-article-1.1514406
...
<section>
    ...
    6.2
    18%
    <aside class="notes">Denver's murder rate was 22% higher than New York's. NYC's murder rate is 18% lower than Denver's. (there are 18% fewer murders in NYC)
...
<section>
    ...
    <aside class="notes">When people say "average" what they usually mean is "mean".
</aside>
</section>
<section>
    # Median vs. Mean
...
<section>
    ...
    Source: Baseball salaries for 2013, Newsday
...
<section>
    ...
    Using "nominal" prices -- prices that aren't adjusted for inflation -- is the equivalent of saying that I'm older now than I've ever been before. It leads to being wrong: http://www.cjr.org/the_audit/misleading_and_incomplete_cove.php
...
<section>
    ...
    New York Magazine has a powerful package on abortion in the Nov 18 issue. I read most of the profiles in a fit of procrastination, including one from Michelle, who paid $800 in 1968. So here's my question: was that a lot of money? 
...
<section>
    # Margin of Error
    "65 percent of likely voters said they will vote for de Blasio, compared to 24 percent for Lhota, a new NBC 4 New York/Wall Street Journal/Marist poll shows." --NBC 4 New York 11/4/13- 
...
<section>
    ...
    What does this margin of error indicate?
...
<section>
    ...
    "A confidence interval is a range around a measurement that conveys how precise the measurement is." - NYS Department of Health
...
<section>
    ...
    Mapping the Storm Cleanup
    And then they started to map streets that had been plowed (that's the blue, white is unplowed). I could map 311 calls and get a more representative distribution but it still wouldn't be a clear snapshot of snow removal. 
...
<section>
    # Writing with Numbers
    Less than 10 applicants showed up. 
    I have less than $20.
    She is fewer than 60 years old. 
    There were far fewer dogs in the park today.
    The mayor wants less people to go hungry.
    Use "fewer" for things you can count: lumps of sugar, cars, people. Use "less" for things you can't count: milk,  traffic, homework. 
